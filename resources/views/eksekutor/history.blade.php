...
@section('title', 'Log Perubahan Status - Eksekutor')
...
<div class="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
    ...
    <div class="mb-8">
        ...
        <p class="mt-2 text-gray-600">
            Seluruh status pengajuan yang diubah oleh verifikator dan eksekutor.
        </p>
    </div>
    ...
    <div class="mb-6 rounded-2xl border border-gray-200 bg-white shadow-sm">
        <div class="p-6">
            <form method="GET" action="{{ route('eksekutor.history') }}" id="filterForm">
                        ...
                        <div 
                            ...
                            <div class="border-b border-gray-200 px-4 py-3">
                                <div class="flex items-center justify-between">
                                    ...
                                    <button 
                                        type="button"
                                        onclick="window.location.href='{{ route('eksekutor.history') }}'"
    ...
    <div class="overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm">
        ...
        <div class="border-b border-gray-200 bg-gray-50 px-6 py-4">
            <h2 class="font-semibold text-gray-900">Log Perubahan Status</h2>
        </div>
        ...
        <div class="p-12 text-center">
            ...
            <p class="mt-2 text-gray-500">Log perubahan status akan muncul di sini.</p>
        </div>
        @else
        ...
        <div class="border-t border-gray-200 bg-gray-50 px-6 py-4">
            <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                ...
                <form method="GET" action="{{ route('eksekutor.history') }}" id="perPageForm" class="flex items-center gap-2">
