...
class SubmissionController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $rules = [
            ...
            'teknis_nama' => 'required|string|max:255',
            'teknis_nip' => 'required|string|max:50',
            'teknis_nik' => 'required|string|max:50',
            'teknis_telepon' => 'required|string|max:20',
        ...
        $messages = [
            ...
            'teknis_nama.required' => 'Nama penanggung jawab teknis wajib diisi.',
    ...
    private function buildKeterangan(array $validated): string
    {
        $data = [
            ...
            'teknis' => [
                'name' => $validated['teknis_nama'],
                'nip' => $validated['teknis_nip'],
                'nik' => $validated['teknis_nik'] ?? null,
